...
### 🌐 Сайт, лаунчер и страницы внутри игры

<div align="center">
<img src="assets/site-tour.gif" alt="Сайт void-rp.ru: главная, серверы, рынок, государства, топ и боевой пропуск" width="100%">

<sub>Сайт <a href="https://void-rp.ru">void-rp.ru</a>: главная → серверы → рынок игроков → государства → топ → боевой пропуск</sub>
</div>

<table>
<tr>
<td width="50%"><img src="assets/launcher-tour.gif" alt="Лаунчер: вход, выбор сервера, главная, государство, рейтинг, настройки"><br><sub><b>Лаунчер</b>: вход → сервер → «Играть» → государство → рейтинг → настройки</sub></td>
<td width="50%"><img src="assets/webgui-tour.gif" alt="WebGUI в игре: меню, боевой пропуск, квесты, биржа"><br><sub><b>WebGUI</b> поверх игры на VoidRP: меню (F6) → пропуск → квесты → биржа</sub></td>
</tr>
</table>

<sub>Сайт, лаунчер и WebGUI сняты с локальных сборок на демо-данных: ники, государства и цены вымышлены.</sub>
